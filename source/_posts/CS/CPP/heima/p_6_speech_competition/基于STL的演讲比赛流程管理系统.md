---
title: 基于STL的演讲比赛流程管理系统
category: 
  - CPP
  - heima
  - p_6_speech_competition
  - 资料
  - 讲义
tags:
  - CPP
...
![1548154762048](基于STL的演讲比赛流程管理系统/1548154762048.png)
...
![1548155966702](基于STL的演讲比赛流程管理系统/1548155966702.png)
...
![1548121881969](基于STL的演讲比赛流程管理系统/1548121881969.png)



* 填写项目名称以及选取项目路径，点击确定生成项目

![1548122271773](基于STL的演讲比赛流程管理系统/1548122271773.png)
...
![1548122420253](基于STL的演讲比赛流程管理系统/1548122420253.png)
...
![1548122619712](基于STL的演讲比赛流程管理系统/1548122619712.png)
...
![1548123402593](基于STL的演讲比赛流程管理系统/1548123402593.png)
...
![1548123942072](基于STL的演讲比赛流程管理系统/1548123942072.png)
...
![1548124599641](基于STL的演讲比赛流程管理系统/1548124599641.png)
...
![1548124853576](基于STL的演讲比赛流程管理系统/1548124853576.png)



运行测试效果如图：

![1548124888578](基于STL的演讲比赛流程管理系统/1548124888578.png)
...
![1548141605742](基于STL的演讲比赛流程管理系统/1548141605742.png)

* 测试效果如图：

![1548141560164](基于STL的演讲比赛流程管理系统/1548141560164.png)
...
![1548143871202](基于STL的演讲比赛流程管理系统/1548143871202.png)

* 在main函数中，分支1选项中，调用开始比赛的接口

![1548143543475](基于STL的演讲比赛流程管理系统/1548143543475.png)



* 测试

![1548143610682](基于STL的演讲比赛流程管理系统/1548143610682.png)
...
![1548144491984](基于STL的演讲比赛流程管理系统/1548144491984.png)



* 再次运行代码，测试比赛

![1548144765146](基于STL的演讲比赛流程管理系统/1548144765146.png)
...
![1548146903960](基于STL的演讲比赛流程管理系统/1548146903960.png)

* 运行代码，测试效果

![1548146961550](基于STL的演讲比赛流程管理系统/1548146961550.png)
...
![1548148593215](基于STL的演讲比赛流程管理系统/1548148593215.png)



测试，将整个比赛流程都跑通

![1548148536395](基于STL的演讲比赛流程管理系统/1548148536395.png)
...
![1548149937860](基于STL的演讲比赛流程管理系统/1548149937860.png)



* 测试，整个比赛完毕后记录保存情况

![1548149912863](基于STL的演讲比赛流程管理系统/1548149912863.png)



利用记事本打开文件 speech.csv，里面保存了前三名选手的编号以及得分

![1548150047975](基于STL的演讲比赛流程管理系统/1548150047975.png)
...
![1548151977242](基于STL的演讲比赛流程管理系统/1548151977242.png)
...
![1548152359604](基于STL的演讲比赛流程管理系统/1548152359604.png)

显示效果如图：（本次测试添加了4条记录）

![1548152394715](基于STL的演讲比赛流程管理系统/1548152394715.png)
...
![1548152803116](基于STL的演讲比赛流程管理系统/1548152803116.png)
...
![1548153005042](基于STL的演讲比赛流程管理系统/1548153005042.png)

3. 比完赛后查不到本届比赛的记录，没有实时更新

解决方式：比赛完毕后，所有数据重置

![1548153319587](基于STL的演讲比赛流程管理系统/1548153319587.png)
...
![1548154340974](基于STL的演讲比赛流程管理系统/1548154340974.png)
...
![1548153571603](基于STL的演讲比赛流程管理系统/1548153571603.png)
...
![1548154674242](基于STL的演讲比赛流程管理系统/1548154674242.png)

运行程序，测试清空记录：

![1548154004738](基于STL的演讲比赛流程管理系统/1548154004738.png)

speech.csv中记录也为空

![1548154508831](基于STL的演讲比赛流程管理系统/1548154508831.png)
