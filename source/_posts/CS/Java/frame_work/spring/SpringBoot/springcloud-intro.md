...
![Spring Cloud 总体架构](springcloud-intro/spring-cloud总体架构.jpg)
...
![](springcloud-intro/4d161e2950414113834f2f0a8fc2c16c-new-imaged17347a0-e653-4830-9542-3d7ae4305b2b.png)

那么现在，我们的模式就是这样的了。

![](springcloud-intro/24382ce6bbd44932ac38b1accade12d1-new-image2ff8affc-6f1d-49de-a8c3-801e7bad2b11.png)
...
![租房-中介模式图](springcloud-intro/租房-中介模式图.jpg)
...
![Eureka架构图](springcloud-intro/5d723c49eca1468ab7b89af06743023c-new-imageb8aa3d41-fad4-4b38-add9-c304930ab285.png)
...
<img src="springcloud-intro/秒杀系统-ribbon.jpg" style="zoom:50%;" />
...
<img src="springcloud-intro/秒杀系统-ribbon2.jpg" style="zoom:50%;" />
...
<img src="springcloud-intro/nginx-vs-ribbon1.jpg" style="zoom:50%;" />

我们可以看到 `Nginx` 是接收了所有的请求进行负载均衡的，而对于 `Ribbon` 来说它是在消费者端进行的负载均衡。如下图。

<img src="springcloud-intro/nginx-vs-ribbon2.jpg" style="zoom:50%;" />
...
<img src="springcloud-intro/Hystrix1.jpg" style="zoom:50%;" />
...
<img src="springcloud-intro/Hystrix2.jpg" style="zoom:50%;" />

这就叫 **服务雪崩**。妈耶，上面两个 **熔断** 和 **降级** 你都没给我解释清楚，你现在又给我扯什么 **服务雪崩** ？:tired_face::tired_face::tired_face:

别急，听我慢慢道来。

![](springcloud-intro/513d7e7f6d574fd799195d05556f4aa7-new-image9265b6bd-41ca-4e62-86f3-4341e5bdbe6c.png)
...
<img src="springcloud-intro/zuul-sj22o93nfdsjkdsf.jpg" style="zoom:50%;" />
...
<img src="springcloud-intro/zuul-sj22o93nfdsjkdsf2312.jpg" style="zoom:50%;" />
...
<img src="springcloud-intro/zuul-sj22o93nfdsjkdsf2312244.jpg" style="zoom:50%;" />
...
<img src="springcloud-intro/zuui-令牌桶限流.jpg" alt="令牌桶限流" style="zoom:50%;" />
...
<img src="springcloud-intro/config-ksksks.jpg" style="zoom:50%;" />
...
![](springcloud-intro/1ada747175704ecba3507074847002d0-new-imagee5249fee-c5ee-4472-9983-f1bd5801387c.png)
...
<img src="springcloud-intro/springcloud-bus-s213dsfsd.jpg" style="zoom:50%;" />
