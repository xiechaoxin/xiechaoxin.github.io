...
![进程示例图片-Windows](java并发基础常见面试题总结/进程示例图片-Windows.png)
...
![Java 线程的状态 ](java并发基础常见面试题总结/Java线程的状态.png)

线程在生命周期中并不是固定处于某一个状态而是随着代码的执行在不同状态之间切换。Java 线程状态变迁如下图所示（图源《Java 并发编程艺术》4.1.4 节）：

![Java 线程状态变迁 ](java并发基础常见面试题总结/Java+线程状态变迁.png)
...
![RUNNABLE-VS-RUNNING](java并发基础常见面试题总结/RUNNABLE-VS-RUNNING.png)
