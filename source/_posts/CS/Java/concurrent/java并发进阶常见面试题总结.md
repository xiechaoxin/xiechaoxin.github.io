...
![](java并发进阶常见面试题总结/synchronized关键字.png)
...
![synchronized关键字原理](java并发进阶常见面试题总结/synchronized关键字原理.png)
...
![synchronized关键字原理](java并发进阶常见面试题总结/synchronized关键字原理2.png)
...
![CPU Cache](java并发进阶常见面试题总结/303a300f-70dd-4ee1-9974-3f33affc6574.png)
...
![JMM(Java内存模型)](java并发进阶常见面试题总结/0ac7e663-7db8-4b95-8d8e-7d2b179f67e8.png)

要解决这个问题，就需要把变量声明为 **`volatile`** ，这就指示 JVM，这个变量是共享且不稳定的，每次使用它都到主存中进行读取。

所以，**`volatile` 关键字 除了防止 JVM 的指令重排 ，还有一个重要的作用就是保证变量的可见性。**

![volatile关键字的可见性](java并发进阶常见面试题总结/d49c5557-140b-4abf-adad-8aac3c9036cf.png)
...
![ThreadLocal数据结构](java并发进阶常见面试题总结/threadlocal数据结构.png)

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](java并发进阶常见面试题总结/ThreadLocal内部类.png)
...
![ThreadPoolExecutor构造方法](java并发进阶常见面试题总结/ThreadPoolExecutor构造方法.png)
...
![Executor框架的工具类](java并发进阶常见面试题总结/Executor框架的工具类.png)
...
![图解线程池实现原理](java并发进阶常见面试题总结/图解线程池实现原理-3620564.png)
...
![JUC原子类概览](java并发进阶常见面试题总结/JUC原子类概览.png)
...
![AQS原理图](java并发进阶常见面试题总结/AQS原理图.png)
