...
![](class-loading-process/类加载过程-完善.png)
...
![](class-loading-process/类加载过程-20220527113101452.png)

详见：[jvm规范5.4](https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-5.html#jvms-5.4) 。

![](class-loading-process/20210607102244508.png)
...
![验证阶段示意图](class-loading-process/验证阶段.png)
...
![基本数据类型的零值](class-loading-process/基本数据类型的零值.png)
