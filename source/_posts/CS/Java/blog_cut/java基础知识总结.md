...
![](java基础知识总结/Java-SE-Specifications.png)
...
![java程序转变为机器代码的过程](java基础知识总结/java程序转变为机器代码的过程.png)
...
![编译型语言和解释型语言](java基础知识总结/编译型语言和解释型语言.png)
...
![](java基础知识总结/20210425151835918.png)
...
![](java基础知识总结/desktopjava核心技术-重载.jpg)
...
![](java基础知识总结/20210422164544846.png)
...
![shallow&deep-copy](java基础知识总结/shallow&deep-copy.png)
...
![check-exception](java基础知识总结/check-exception.png)
...
![](java基础知识总结/a478c74d-2c48-40ae-9374-87aacf05188c.png)
...
![IO-操作方式分类](java基础知识总结/IO-操作方式分类.png)

按操作对象分类结构图：

![IO-操作对象分类](java基础知识总结/IO-操作对象分类.png)
