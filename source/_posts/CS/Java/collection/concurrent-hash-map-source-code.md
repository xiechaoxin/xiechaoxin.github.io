...
![Java 7 ConcurrentHashMap 存储结构](concurrent-hash-map-source-code/image-20200405151029416.png)
...
![Java8 ConcurrentHashMap 存储结构（图片来自 javadoop）](concurrent-hash-map-source-code/java8_concurrenthashmap.png)
