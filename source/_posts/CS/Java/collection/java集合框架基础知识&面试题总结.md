...
![](java集合框架基础知识&面试题总结/java-collection-hierarchy.png)
...
![双向链表](java集合框架基础知识&面试题总结/双向链表.png)

**双向循环链表：** 最后一个节点的 next 指向 head，而 head 的 prev 指向最后一个节点，构成一个环。

![双向循环链表](java集合框架基础知识&面试题总结/双向循环链表.png)
...
![](java集合框架基础知识&面试题总结/TreeMap继承结构.png)
...
![jdk1.8之前的内部结构-HashMap](java集合框架基础知识&面试题总结/jdk1.8之前的内部结构-HashMap.png)

#### JDK1.8 之后

相比于之前的版本， JDK1.8 之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为 8）（将链表转换成红黑树前会判断，如果当前数组的长度小于 64，那么会选择先进行数组扩容，而不是转换为红黑树）时，将链表转化为红黑树，以减少搜索时间。

![jdk1.8之后的内部结构-HashMap](java集合框架基础知识&面试题总结/jdk1.8之后的内部结构-HashMap.png)
...
![Hashtable全表锁](java集合框架基础知识&面试题总结/HashTable全表锁.png)

<p style="text-align:right;font-size:13px;color:gray">https://www.cnblogs.com/chengxiao/p/6842045.html></p>

**JDK1.7 的 ConcurrentHashMap：**

![JDK1.7的ConcurrentHashMap](java集合框架基础知识&面试题总结/ConcurrentHashMap分段锁.jpg)

<p style="text-align:right;font-size:13px;color:gray">https://www.cnblogs.com/chengxiao/p/6842045.html></p>

**JDK1.8 的 ConcurrentHashMap：**

![Java8 ConcurrentHashMap 存储结构（图片来自 javadoop）](java集合框架基础知识&面试题总结/java8_concurrenthashmap-3620210.png)
