...
<img src="MOOC_C程序设计笔记/20200506234629.png" style="zoom:30%;" />
...
![image-20200506235452769](MOOC_C程序设计笔记/20200506235456.png)
...
<img src="MOOC_C程序设计笔记/20200506234717.png" style="zoom:85%;" />
...
<img src="../../../../../../../kungfu/Desktop/typora图片/C语言/截屏2020-03-1016.22.38.png" alt="截屏2020-03-1016.22.38" style="zoom:60%;" />
...
<img src="MOOC_C程序设计笔记/20200507012750.png" alt="截屏2020-03-1017.02.27" style="zoom:60%;" />
...
![](MOOC_C程序设计笔记/20200507012825.png)

==先定义的变量地址大，后定义的变量地址小；因为它们是自上而下存储在内存stack中==

- 数组的地址、数组单元的地址、相邻的数组单元的地址

![截屏2020-03-1022.46.04](MOOC_C程序设计笔记/20200507012832.png)
...
![截屏2020-03-1114.20.46](MOOC_C程序设计笔记/20200507012841.png)
...
![截屏2020-03-1217.25.15](MOOC_C程序设计笔记/20200507012855.png)
...
- ```c
  ...
  - 可定义成`char a[][10]`
    ...
    <img src="MOOC_C程序设计笔记/20200507012918.png" alt="image-20200322205413652" style="zoom:40%;" />
...
- ```c
  ...
  <img src="MOOC_C程序设计笔记/20200507012925.png" alt="image-20200322205506736" style="zoom:40%;" />
...
- `argv[0]`是命令本身
  ...
  ![image-20200322220102668](MOOC_C程序设计笔记/20200507012931.png)

  - 执行`a.out`时，命令行中输入的东西会依次放入`argv[]`数组中

- 若将一个链接`my`指向`a.out`

  ![image-20200322220330071](MOOC_C程序设计笔记/20200507012937.png)
...
![image-20200322220420886](MOOC_C程序设计笔记/20200507013045.png)

![image-20200322220458622](MOOC_C程序设计笔记/20200507013050.png)
...
![image-20200322221835427](MOOC_C程序设计笔记/20200507013106.png)

**自己写一个输出字符串长度的函数**

![image-20200322223634013](MOOC_C程序设计笔记/20200507013115.png)
...
![image-20200323155856510](MOOC_C程序设计笔记/20200507013125.png)
...
![image-20200323161213363](MOOC_C程序设计笔记/20200507013132.png)
...
![image-20200323181412648](MOOC_C程序设计笔记/20200507013142.png)

**找到字符并将该字符以及该字符以后的东西复制到另一个字符串中去**

![image-20200323182027826](MOOC_C程序设计笔记/20200507013147.png)

**输出所找字符前面的字符串，不包括该字符**

![image-20200323182337053](MOOC_C程序设计笔记/20200507013154.png)
...
![image-20200324163928678](MOOC_C程序设计笔记/20200507013206.png)
...
![image-20200325171351300](MOOC_C程序设计笔记/20200507013231.png)
...
- 静态本地变量的初始化***只会在第一次进入***这个函数时做，以后进入函数会保持上次离开时的值
  ...
  ![image-20200325180255593](MOOC_C程序设计笔记/20200507013238.png)

- 静态本地变量实际上是特殊的全局变量

- 它们位于相同的内存区域

  ![image-20200325181457617](MOOC_C程序设计笔记/20200507013243.png)
...
- **#define用来定义一个宏**
  ...
  ![image-20200325220301532](MOOC_C程序设计笔记/20200507013252.png)

  - `gcc --save-temps main.c`会保留编译过程当中的临时文件

  - `.c`经过编译预处理，产生一个中间结果文件`.i`

    ![image-20200325220906836](MOOC_C程序设计笔记/20200507013257.png)
...
- 它会把头文件的全部内容原封不动的插入到它所在的地方
  ...
  - 所以也不一定要在.c文件的最前面`#include`
    ...
    ![image-20200327165326676](MOOC_C程序设计笔记/20200507013313.png)

    - `gcc`可以同时编译多个`.c`文件

    ![image-20200327165440607](MOOC_C程序设计笔记/20200507013319.png)

    - `gcc --save-temps main.c -c `只对main.c做编译，不做链接 

    ![image-20200327170014274](MOOC_C程序设计笔记/20200507013327.png)

    - 查看`main.i`的最后50行

    ![image-20200327170255743](MOOC_C程序设计笔记/20200507013333.png)
...
- 左对齐
  ...
  ![image-20200327221910852](MOOC_C程序设计笔记/20200507013346.png)

- 输出+

  ![image-20200327222425166](MOOC_C程序设计笔记/20200507013352.png)

- 0填充

  ![image-20200327223525609](MOOC_C程序设计笔记/20200507013358.png)
...
- `.number`
  ...
  ![image-20200327224215287](MOOC_C程序设计笔记/20200507013406.png)

- `*` 和 `.*`

  ![image-20200327225442217](MOOC_C程序设计笔记/20200507013411.png)
...
- hh
  ...
  ![image-20200327230242171](MOOC_C程序设计笔记/20200507013418.png)
...
- n
  ...
  ![image-20200328012206429](MOOC_C程序设计笔记/20200507013424.png)
...
- `*`
  ...
  ![image-20200328014243270](MOOC_C程序设计笔记/20200507013432.png)
...
- `i`
  ...
  ![image-20200328014120732](MOOC_C程序设计笔记/20200507013439.png)
...
- 输出的字符数（包括末尾的\n换行，也算一个字符）
  ...
  ![image-20200328015934837](MOOC_C程序设计笔记/20200507013446.png)
...
- 运行test，读取数据，并将输出结果保存在12.out里面
  ...
  ![image-20200328145116532](MOOC_C程序设计笔记/20200507013456.png)

- 打开12.out

  ![image-20200328145149826](MOOC_C程序设计笔记/20200507013506.png)

- 将输入结果放在12.in里面

  ![image-20200328145339187](MOOC_C程序设计笔记/20200507013515.png)

- 运行test，将文件12.in里面的内容输入，并得到输出结果

  ![image-20200328145432195](MOOC_C程序设计笔记/20200507013520.png)

- 运行test，将文件12.in里面的内容输入，并将输出结果放在12.out里面

  ![image-20200328145614464](MOOC_C程序设计笔记/20200507013526.png)
...
![image-20200328151259014](MOOC_C程序设计笔记/20200507013550.png)

- 12.in里面存放的是12345
- 删除12.in

![image-20200328151422766](MOOC_C程序设计笔记/20200507013554.png)
...
![image-20200328175707259](MOOC_C程序设计笔记/20200507013608.png)

![image-20200328175615732](MOOC_C程序设计笔记/20200507013612.png)
...
- 把一个int的若干为组合成一个结构
  ...
  ![image-20200328195509987](MOOC_C程序设计笔记/20200507013619.png)
...
- 他们俩合起来可以实现`array_at`的功能
  ...
  ![image-20200328215754737](MOOC_C程序设计笔记/20200507013628.png)
