...
![通过github-readme-stats动态生成GitHub统计信息 ](github技巧/image-20210616221312426.png)
...
![项目徽章](github技巧/image-20201107143136559.png)

并且，你不光可以生成静态徽章，shield.io 还可以动态读取你项目的状态并生成对应的徽章。

![自定义项目徽章](github技巧/image-20201107143502356.png)

生成的描述项目状态的徽章效果如下图所示。

![描述项目状态的徽章](github技巧/image-20201107143752642.png)

## 4. Github 表情

![Github表情](github技巧/image-20201107162254582.png)

如果你想要在 Github 使用表情的话，可以在这里找找 ：[www.webfx.com/tools/emoji-cheat-sheet/ ](www.webfx.com/tools/emoji-cheat-sheet/)。

![在线Github表情](github技巧/image-20201107162432941.png)
...
![Chrome插件Octotree](github技巧/image-20201107144944798.png)
...
![](github技巧/image-20201107160817672.png)
...
![](<github技巧/iShot2020-11-07 16.14.14 (1).png>)
