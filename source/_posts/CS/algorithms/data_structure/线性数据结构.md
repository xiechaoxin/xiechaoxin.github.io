...
![循环链表](线性数据结构/循环链表2.png)

#### 2.2.3. 双向链表

**双向链表** 包含两个指针，一个 prev 指向前一个节点，一个 next 指向后一个节点。

![双向链表](线性数据结构/双向链表-20220527134907417.png)

#### 2.2.4. 双向循环链表

**双向循环链表** 最后一个节点的 next 指向 head，而 head 的 prev 指向最后一个节点，构成一个环。

![双向循环链表](线性数据结构/双向循环链表-20220527134907415.png)
...
![栈实现浏览器倒退和前进](线性数据结构/栈实现浏览器倒退和前进.png)
