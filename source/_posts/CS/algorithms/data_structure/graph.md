...
![无向图的邻接矩阵存储](graph/无向图的邻接矩阵存储.png)

值得注意的是：**无向图的邻接矩阵是一个对称矩阵，因为在无向图中，顶点i和顶点j有关系，则顶点j和顶点i必有关系。**

![有向图的邻接矩阵存储](graph/有向图的邻接矩阵存储.png)
...
![无向图的邻接表存储](graph/无向图的邻接表存储.png)



![有向图的邻接表存储](graph/有向图的邻接表存储.png)
...
![广度优先搜索图示](graph/广度优先搜索图示.png)

**广度优先搜索的具体实现方式用到了之前所学过的线性数据结构——队列** 。具体过程如下图所示：

**第1步：**

![广度优先搜索1](graph/广度优先搜索1.png)

**第2步：**

![广度优先搜索2](graph/广度优先搜索2.png)

**第3步：**

![广度优先搜索3](graph/广度优先搜索3.png)

**第4步：**

![广度优先搜索4](graph/广度优先搜索4.png)

**第5步：**

![广度优先搜索5](graph/广度优先搜索5.png)

**第6步：**

![广度优先搜索6](graph/广度优先搜索6.png)

### 深度优先搜索

深度优先搜索就是“一条路走到黑”，从源顶点开始，一直走到没有后继节点，才回溯到上一顶点，然后继续“一条路走到黑”，如下图所示：

![深度优先搜索图示](graph/深度优先搜索图示.png)
...
![深度优先搜索1](graph/深度优先搜索1.png)

**第2步：**

![深度优先搜索1](graph/深度优先搜索2.png)

**第3步：**

![深度优先搜索1](graph/深度优先搜索3.png)

**第4步：**

![深度优先搜索1](graph/深度优先搜索4.png)

**第5步：**

![深度优先搜索1](graph/深度优先搜索5.png)

**第6步：**

![深度优先搜索1](graph/深度优先搜索6.png)
