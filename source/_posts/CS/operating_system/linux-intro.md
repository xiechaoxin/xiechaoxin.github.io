---
title: linux-intro(后端程序员必备的 Linux 基础知识总结)
category: 
  - operating_system
tags:
  - operating_system
...
![](linux-intro/image-20200807161118901.png)
...
![Kernel_Layout](linux-intro/Kernel_Layout.png)
...
_玩玩电脑游戏还是必须要有 Windows 的 ~_

![windows](linux-intro/windows.png)
...
![](linux-intro/L181kk2Eou-compress.jpg)
...
![OPINION: Make the switch to a Linux operating system | Opinion ...](linux-intro/Linux-Logo.png)
...
![文件inode信息](linux-intro/文件inode信息.png)
...
![Linux的目录结构](linux-intro/Linux目录树.png)
...
![](linux-intro/Linux权限命令.png)

第一列的内容的信息解释如下：

![](linux-intro/Linux权限解读.png)
