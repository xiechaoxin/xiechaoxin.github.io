...
![事务的特性](transaction-isolation-level/事务特性.png)
...
<img src="transaction-isolation-level/2019-31-1脏读(读未提交)实例.jpg" width="800px"/>


#### 避免脏读(读已提交)

<img src="transaction-isolation-level/2019-31-2读已提交实例.jpg" width="800px"/>
...
<img src="transaction-isolation-level/2019-32-1不可重复读实例.jpg"/>


#### 可重复读

<img src="transaction-isolation-level/2019-33-2可重复读.jpg"/>


#### 防止幻读(可重复读)

<img src="transaction-isolation-level/2019-33防止幻读(使用可重复读).jpg"/>
