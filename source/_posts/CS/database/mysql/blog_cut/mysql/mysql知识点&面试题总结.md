...
![](mysql知识点&面试题总结/5e3c1a71724a38245aa43b02_99bf70d46cc247be878de9d3a88f0c44.png)
...
![](mysql知识点&面试题总结/20210327143351823.png)
...
![查看MySQL提供的所有存储引擎](mysql知识点&面试题总结/mysql-engines.png)
...
![查看表的存储引擎](mysql知识点&面试题总结/查看表的存储引擎.png)

### MyISAM 和 InnoDB 的区别

![](mysql知识点&面试题总结/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM0MzM3Mjcy,size_16,color_FFFFFF,t_70-20220527142425077.png)
...
![](mysql知识点&面试题总结/640-20201207160554677.png)

另外，关系型数据库（例如：`MySQL`、`SQL Server`、`Oracle` 等）事务都有 **ACID** 特性：

![事务的特性](mysql知识点&面试题总结/事务特性-20220527142424173.png)
