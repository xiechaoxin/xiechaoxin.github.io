...
![在这里插入图片描述](mysql详细笔记11-12章/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6Zmz6aiw6aOb,size_20,color_FFFFFF,t_70,g_se,x_16-20220523012811895.png)

> 解决方式：使用 INSERT 语句向表中插入数据。

### 11.1.2 方式1：VALUES的方式添加
...
![在这里插入图片描述](mysql详细笔记11-12章/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6Zmz6aiw6aOb,size_20,color_FFFFFF,t_70,g_se,x_16-20220523012812084.png)
...
![在这里插入图片描述](mysql详细笔记11-12章/105c428d3bb4404abad7ca54d991bf81.png)
...
![在这里插入图片描述](mysql详细笔记11-12章/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6Zmz6aiw6aOb,size_20,color_FFFFFF,t_70,g_se,x_16-20220523012811919.png)

*   使用 DELETE 语句从表中删除数据  
    ![在这里插入图片描述](mysql详细笔记11-12章/ef1ebd205d7f43cd949777ee51781b21.png)
...
![在这里插入图片描述](mysql详细笔记11-12章/7c9a90393fa44478bc85d45ded680f68.png)
...
> *   FLOAT 表示单精度浮点数；
> *   DOUBLE 表示双精度浮点数；  
>     ![在这里插入图片描述](mysql详细笔记11-12章/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6Zmz6aiw6aOb,size_20,color_FFFFFF,t_70,g_se,x_16-20220523012812155.png)
> *   REAL默认就是 DOUBLE。如果你把 SQL 模式设定为启用“`REAL_AS_FLOAT`”，那 么，MySQL 就认为 REAL 是 FLOAT。如果要启用“REAL\_AS\_FLOAT”，可以通过以下 SQL 语句实现：SET sql\_mode = “REAL\_AS\_FLOAT”;
...
**举例**：我们运行下面的语句，把test\_double2表中字段“f1”的数据类型修改为
...
> **经验**： 由于 DECIMAL 数据类型的精准性，在我们的项目中，除了极少数（比如商品编号）用到整数类型外，其他的数值都用的是 DECIMAL，原因就是这个项目所处的零售行业，要求精准，一分钱也不能差。
...
![在这里插入图片描述](mysql详细笔记11-12章/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6Zmz6aiw6aOb,size_20,color_FFFFFF,t_70,g_se,x_16-20220523012812646.png)
...
![在这里插入图片描述](mysql详细笔记11-12章/3905045083d2412d8da8e2e0bc128c20.png)  
...
![在这里插入图片描述](mysql详细笔记11-12章/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6Zmz6aiw6aOb,size_20,color_FFFFFF,t_70,g_se,x_16-20220523012812237.png)

> *   MultiPoint、MultiLineString、MultiPolygon、GeometryCollection 这4种类型都是集合类，是多个Point、LineString或Polygon组合而成。

下面展示的是多个同类或异类几何图形元素的组合：  
![在这里插入图片描述](mysql详细笔记11-12章/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA6Zmz6aiw6aOb,size_20,color_FFFFFF,t_70,g_se,x_16-20220523012812544.png)
