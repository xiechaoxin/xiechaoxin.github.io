---
title: idea-plug-in-development-intro
category: 
  - tools
  - idea_tutorial
  - idea_tips
...
![](idea-plug-in-development-intro/image-20201118071711216.png)
...
![选择 Gradle 项目类型并勾选上相应的依赖](idea-plug-in-development-intro/1.png)

**第二步，填写项目相关的属性比如 GroupId、ArtifactId。**

![填写项目相关的属性](idea-plug-in-development-intro/2.png)
...
![插件项目结构概览](idea-plug-in-development-intro/插件项目结构概览.png)
...
![插件信息](idea-plug-in-development-intro/iShot2020-11-13 16.15.53.png)

这就非常贴心了！如果这都不能让你点赞，我要这文章有何用!

![](idea-plug-in-development-intro/006BkP2Hly1fsxxff7zd9g304g0480td.gif)
...
![](<idea-plug-in-development-intro/新建action (1).png>)

**第二步，配置 Action 相关信息比如展示名称。**

![配置动作属性 (1)](<idea-plug-in-development-intro/配置动作属性 (1).png>)
...
![](idea-plug-in-development-intro/image-20201113192255689.png)
...
![](idea-plug-in-development-intro/image-20201113201634643.png)

## 04 验收成果

点击 `Gradle -> runIde` 就会启动一个默认了这个插件的 IDEA。然后，你可以在这个 IDEA 上实际使用这个插件了。

![点击 runIde 就会启动一个默认了这个插件的 IDEA](idea-plug-in-development-intro/image-20201118075912490.png)

效果如下：

![点击 runIde 就会启动一个默认了这个插件的 IDEA](idea-plug-in-development-intro/image-20201118080358764.png)

我们点击自定义的 Hello Action 的话就会弹出一个对话框并展示出我们自定义的信息。

![IDEA插件HelloWorld](idea-plug-in-development-intro/IDEA插件HelloWorld.png)
...
![](idea-plug-in-development-intro/image-20201114100213337.png)

首先，你需要在[图灵机器人官网](http://www.tuling123.com/ "图灵机器人官网")申请一个机器人。（_其他机器人也一样，感觉这个图灵机器人没有原来好用了，并且免费调用次数也不多_）

![](idea-plug-in-development-intro/image-20201118075453172.png)

然后，简单写一个方法来请求调用机器人。由于代码比较简单，我这里就不放出来了，大家简单看一下效果就好。

![](idea-plug-in-development-intro/image-20201118075803163.png)
