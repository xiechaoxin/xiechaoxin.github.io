...
![](idea-refractor-intro/refractor-help.png)

### 重命名(rename)

快捷键：**Shift + F6(mac) / Shift + F6(windows/Linux)：** 对类、变量或者方法名重命名。

![重命名](idea-refractor-intro/rename.gif)
...
![](idea-refractor-intro/extract-constant.gif)
...
![](idea-refractor-intro/exact-parameter.gif)
...
![](idea-refractor-intro/exact-variable.gif)
...
![](idea-refractor-intro/exact-field.gif)
...
![](idea-refractor-intro/exact-method.gif)
...
![](idea-refractor-intro/exact-interface.gif)
