---
title: idea-source-code-reading-skills
category: 
  - tools
  - idea_tutorial
  - idea_tips
...
![](idea-source-code-reading-skills/20210527135533686.png)
...
![](idea-source-code-reading-skills/20210527135552183.png)
...
![](idea-source-code-reading-skills/20210527135629367.png)
...
![](idea-source-code-reading-skills/20210527135703164.png)
...
![](idea-source-code-reading-skills/20210527135712962.png)
...
![](idea-source-code-reading-skills/20210527135733816.png)
...
![](idea-source-code-reading-skills/20210527135745518.png)

你还可以对图表进行一些操作。比如，你可以点击图表中具体的类 **右键**，然后选择显示它的实现类或者父类。

![](idea-source-code-reading-skills/20210527135757163.png)

再比如你还可以选择是否显示类中的属性、方法、内部类等等信息。

![](idea-source-code-reading-skills/20210527135902827.png)

如果你想跳转到对应类的源码的话，直接点击图表中具体的类 **右键** ，然后选择 **Jump to Source** 。

![](idea-source-code-reading-skills/20210527135807668.png)
...
![](idea-source-code-reading-skills/2021052218304014.png)

**如何使用呢？**

1、选中方法名（注意不要选类名），然后点击鼠标右键，选择 **Sequence Diagram** 选项即可！

![](idea-source-code-reading-skills/20201021170110697.png)

2、配置生成的序列图的一些基本的参数比如调用深度之后，我们点击 ok 即可！

![](idea-source-code-reading-skills/c5040f1105c762ddf8689892913bc02d.png)

3、你还可以通过生成的时序图来定位到相关的代码，这对于我们阅读源码的时候尤其有帮助！

![](idea-source-code-reading-skills/20201021171623809.png)

4、时序图生成完成之后，你还可以选择将其导出为图片。

![](idea-source-code-reading-skills/20201021170228723.png)
...
![](idea-source-code-reading-skills/20210522183550110.png)

有了这个插件之后你可以非常直观地看到你的项目中所有类型的文件的信息比如数量、大小等等，可以帮助你更好地了解你们的项目。

![](idea-source-code-reading-skills/20210522183616310.png)

你还可以使用它看所有类的总行数、有效代码行数、注释行数、以及有效代码比重等等这些东西。

![](idea-source-code-reading-skills/20210522183630459.png)
