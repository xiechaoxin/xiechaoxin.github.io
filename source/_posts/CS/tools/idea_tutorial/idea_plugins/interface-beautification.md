---
title: interface-beautification
category: 
  - tools
  - idea_tutorial
  - idea_plugins
...
![Background Image Plus](interface-beautification/image-20211010174138279.png)

通过这个插件，你可以将 IDEA 背景设置为指定的图片，支持随机背景。

效果图如下：

![Background Image Plus 设置背景效果图](interface-beautification/image-20211010173730828.png)
...
![Power Mode II 效果图](interface-beautification/Power-Mode-II.gif)

你可以通过 IDEA 设置页 **Settings** -> **Appearance & Behaviour** -> **Power Mode II** 自定义设置项。

![Power Mode II](interface-beautification/image-20211010175304108.png)

## Nyan Progress Bar : 进度条美化

可以让你拥有更加漂亮的进度条。

![](interface-beautification/image-20211010175434133.png)
...
![](interface-beautification/grep-console2.png)

配置完成之后的 log warn 的效果对比图如下：

![](interface-beautification/grep-console3.png)

**2. 过滤控制台输出**

![](interface-beautification/grep-console.gif)

## Rainbow Brackets : 彩虹括号

使用各种鲜明的颜色来展示你的括号，效果图如下。可以看出代码层级变得更加清晰了，可以说非常实用友好了！

![](interface-beautification/rainbow-brackets.png)
