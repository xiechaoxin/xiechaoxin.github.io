...
![](rest-devlop/41a9bfa18920403ba4db83e324f8621e~tplv-k3u1fbpfcp-zoom-1.image)
...
![](rest-devlop/c26ea05ad472488fbf9eb21627964bee~tplv-k3u1fbpfcp-zoom-1.image)

#### 作为 HTTP 请求工具

这个插件还可以作为一个简单的 http 请求工具来使用。如下图所示。

![](rest-devlop/RestfulToolkit2.png)
...
![](rest-devlop/RestfulToolkit3.png)
...
![](rest-devlop/RestfulToolkit4.png)
...
![](rest-devlop/image-20210830112030237.png)
