...
![](improve-code/Codota1.gif)

我们创建线程池现在变成下面这样：

![](improve-code/Codota4.gif)
...
![](improve-code/Alibaba-Java-Code-Guidelines2.png)
...
![](improve-code/Alibaba-Java-Code-Guidelines3.png)

### 使用效果

这个插件会实时检测出我们的代码不匹配它的规则的地方，并且会给出修改建议。比如我们按照下面的方式去创建线程池的话，这个插件就会帮我们检测出来,如下图所示。

![](improve-code/Alibaba-Java-Code-Guidelines1.png)

这个可以对应上 《阿里巴巴Java开发手册》 这本书关于创建线程池的方式说明。

![](improve-code/阿里巴巴开发手册-线程池创建.png)
...
![](improve-code/image-20201013135044410.png)
...
![](improve-code/image-20201013103610557.png)

安装插件之后重启 IDEA，你会发现就可以在底部菜单栏找到 CheckStyle 了。

![](improve-code/image-20201013134644991.png)

### 如何自定义检测规则？

如果你需要自定义代码格式检测规则的话，可以按照如下方式进行配置（你可以导入用于自定义检测规则的`CheckStyle.xml`文件）。

![](improve-code/setting-check-style.png)

### 使用效果

配置完成之后，按照如下方式使用这个插件！

![run-check-style](improve-code/run-check-style.png)
...
![](improve-code/image-20201019222817359.png)
