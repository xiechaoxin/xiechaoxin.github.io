...
![认识容器](docker从入门到实战/container-20220527152744745.png)
...
![](docker从入门到实战/20210412220015698.png)
...
![](docker从入门到实战/up-4e3146984adaee0067bdc5e9b1d757bb479.png)

然后点击`Get Started`：

![](docker从入门到实战/up-96adfbfebe3e59097c8ba25e55f68ba7908.png)

在此处点击`Download for Windows`即可进行下载。

如果你的电脑是`Windows 10 64位专业版`的操作系统，则在安装 Docker 之前需要开启一下`Hyper-V`，开启方式如下。打开控制面板，选择程序：

![](docker从入门到实战/up-73ce678240826de0f49225250a970b4d205.png)

点击`启用或关闭Windows功能`：

![](docker从入门到实战/up-9c7a96c332e56b9506325a1f1fdb608a659.png)

勾选上`Hyper-V`，点击确定即可：

![](docker从入门到实战/up-aad4a58c5e917f7185908d6320d7fb06861.png)

完成更改后需要重启一下计算机。

开启了`Hyper-V`后，我们就可以对 Docker 进行安装了，打开安装程序后，等待片刻点击`Ok`即可：

![](docker从入门到实战/up-62ac3c9184bdc21387755294613ff5054c6.png)

安装完成后，我们仍然需要重启计算机，重启后，若提示如下内容：

![](docker从入门到实战/up-3585c7d6a4632134ed925493a7d43e14a43.png)
...
![](docker从入门到实战/up-37d083cc92fe36aad829e975646b9d27fa0.png)

在左上角的搜索框中输入`MySQL`并回车：

![](docker从入门到实战/up-ced37002391a059754def9b3a6c2aa4e342.png)

可以看到相关 MySQL 的镜像非常多，若右上角有`OFFICIAL IMAGE`标识，则说明是官方镜像，所以我们点击第一个 MySQL 镜像：

![](docker从入门到实战/up-48ba3fdc99c93a96e18b929195ca8e93c6c.png)

右边提供了下载 MySQL 镜像的指令为`docker pull MySQL`，但该指令始终会下载 MySQL 镜像的最新版本。

若是想下载指定版本的镜像，则点击下面的`View Available Tags`：

![](docker从入门到实战/up-ed601649275c6cfe65bbe422b463c263a64.png)
...
![](docker从入门到实战/up-0a46effd262d3db1b613a0db597efa31f34.png)

点击控制台：

![](docker从入门到实战/up-60f198e0106be6b43044969d2900272504f.png)

然后点击左上角的菜单，在弹窗的窗口中，将鼠标悬停在产品与服务上，并在右侧搜索容器镜像服务，最后点击容器镜像服务：

![](docker从入门到实战/up-2f6706a979b405dab01bc44a29bb6b26fc4.png)
...
![](docker从入门到实战/up-559083ae80e7501e86e95fbbad25b6d571a.png)
...
![](docker从入门到实战/up-68394e25f652964bb042571151c5e0fd2e9.png)

若是查询的版本不存在，则结果为空：

![](docker从入门到实战/up-abfdd51b9ad2ced3711268369f52b077b12.png)
...
![](docker从入门到实战/up-bd48e20ef07b7c91ad16f92821a3dbca5b5.png)
...
![](docker从入门到实战/up-16d9ff4d29094681f51424ea8d0ee4fd73e.png)
...
![](docker从入门到实战/up-7ec71a682712e56e90490f55c32cf660fd3.png)
...
![](docker从入门到实战/up-fd17796322f833685ca8ead592d38581898.png)
...
![](docker从入门到实战/up-fca74d4350cdfebfc2b06101e1cab411619.png)
...
![](docker从入门到实战/up-8fa1b23f6ea2567b5938370e7d7f636533f.png)
...
![](docker从入门到实战/up-712716a8c8c444ba3a77ade8ff27e7c6cf5.png)
