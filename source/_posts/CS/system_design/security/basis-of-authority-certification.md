---
title: basis-of-authority-certification
category: 
  - system_design
  - security
tags:
...
![](basis-of-authority-certification/20210604160908352.png)

授权：

![](basis-of-authority-certification/20210604161032412.png)
...
![RBAC](basis-of-authority-certification/RBAC.png)

**在 RBAC 中，权限与角色相关联，用户通过成为适当角色的成员而得到这些角色的权限。这就极大地简化了权限的管理。**

本系统的权限设计相关的表如下（一共 5 张表，2 张用户建立表之间的联系）：

![](basis-of-authority-certification/数据库设计-权限.png)

通过这个权限模型，我们可以创建不同的角色并为不同的角色分配不同的权限范围（菜单）。

![](basis-of-authority-certification/权限管理模块.png)

通常来说，如果系统对于权限控制要求比较严格的话，一般都会选择使用 RBAC 模型来做权限控制。

## 什么是 Cookie ? Cookie 的作用是什么?

![](basis-of-authority-certification/20210615162505880.png)
...
![](basis-of-authority-certification/session-cookie.png)
...
![](basis-of-authority-certification/20210615161108272.png)
...
![jwt](basis-of-authority-certification/jwt.png)
...
![sso](basis-of-authority-certification/sso.png)
...
![](basis-of-authority-certification/微信支付-fnglfdlgdfj.png)

下图是 [Slack OAuth 2.0 第三方登录](https://api.slack.com/legacy/oauth)的示意图：

![](basis-of-authority-certification/20210615151716340.png)
