...
![](定时任务/20210608080437356.png)

ElasticJob-Lite 的架构设计如下图所示：

![](定时任务/up-a8f63f828666d43009d5d3497bcbd2cfb61.png)
...
![](定时任务/20210528144611728.png)

`XXL-JOB` 于 2015 年开源，是一款优秀的轻量级分布式任务调度框架，支持任务可视化管理、弹性扩容缩容、任务失败重试和告警、任务分片等功能，

![](定时任务/20210608080550433.png)

根据 `XXL-JOB` 官网介绍，其解决了很多 `Quartz` 的不足。

![](定时任务/20210607202503193.png)

`XXL-JOB` 的架构设计如下图所示：

![](定时任务/up-b8ecc6acf651f112c4dfae98243d72adea3.png)
...
![](定时任务/up-795f5e9b0d875063717b1ee6a08f2ff1c01.png)
