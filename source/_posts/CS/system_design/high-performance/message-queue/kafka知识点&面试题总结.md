...
![队列模型](kafka知识点&面试题总结/队列模型23.png)
...
![发布订阅模型](kafka知识点&面试题总结/发布订阅模型.png)
...
![Kafka Topic Partition](kafka知识点&面试题总结/KafkaTopicPartitioning.png)
...
<img src="kafka知识点&面试题总结/zookeeper-kafka.jpg" style="zoom:50%;" />
...
![](kafka知识点&面试题总结/KafkaTopicPartionsLayout.png)
...
![kafka offset](kafka知识点&面试题总结/kafka-offset.jpg)
